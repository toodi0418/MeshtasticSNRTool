...
- 2025-12-11：Relay 模式路徑驗證會允許 Meshtastic 報回的「單跳 Roof」路徑，只要 route metadata 內包含 Roof ID 即視為有效，同時仍支援完整 Local → Roof → Mountain 的嚴格比對；缺漏 Mountain/Local 會給出警告但不會阻擋樣本。
