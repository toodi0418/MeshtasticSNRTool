...
impl Transport for SerialTransport {
    ...
    async fn send_admin(&mut self, _dest: &str, _admin_msg: meshtastic::protobufs::AdminMessage) -> Result<()> {
        Err(anyhow::anyhow!("Admin messages not implemented for Serial transport"))
    }
